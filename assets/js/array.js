...
const result = nums6.reduce((acc, num, index, arr) => (acc += num));

/*
  Ще один калькулятор
  зробити функцію яка буде приймати знак
  і буде повертати іншу функцію
  друга функція може приймати необмежену кількість аргументів
  друга функція в залежності від знаку має повертати або суму або різність або поділити чисел один на одне
  (+, -, * , /)
